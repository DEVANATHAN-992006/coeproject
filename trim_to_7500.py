...
# Let's write a python script to trim sentences to bring character count under 7500.
t = report.strip()
print("Original len:", len(t))

# Let's compress further by removing non-essential filler words while keeping exact bullet structure
import re
t2 = re.sub(r' +', ' ', t)
print("Trimmed len:", len(t2))
